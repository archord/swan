 ...
 * @author xy
 */
@Service(value = "otCmbDiffObserveRecordService")
public class OtCmbDiffObserveRecordServiceImpl implements OtObserveRecordService {

  private static final Log log = LogFactory.getLog(OtCmbDiffObserveRecordServiceImpl.class);
