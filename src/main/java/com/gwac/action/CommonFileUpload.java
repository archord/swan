...
public class CommonFileUpload extends ActionSupport implements ApplicationAware {
  ...
  public void storeOT2Image(List<File> files, List<String> fnames, String path) {
