...
public class GetUploadFileUnstoreList extends ActionSupport implements SessionAware {
  ...
  // Your result List
  private List<UploadFileUnstore> gridModel;
...
//  private List<DataProcessMachine> dpmList;
  ...
  public String execute() {
    ...
    int[] sorts = {2};
    gridModel = ufuDao.findRecord(from, rows, orderNames, sorts);
    log.debug("from="+from);
    log.debug("to="+to);
   ...
   */
  public List<UploadFileUnstore> getGridModel() {
    return gridModel;
  }
   ...
   */
  public void setGridModel(List<UploadFileUnstore> gridModel) {
