...
// Generated 2015-1-19 19:26:47 by Hibernate Tools 3.6.0
 ...
 */
@Entity
@Table(name = "fits_file_cut_ref", schema = "public"
)
public class FitsFileCutRef implements java.io.Serializable {
  ...
  public FitsFileCutRef(long ffcrId, Long otId, String fileName, String storePath, Date generateTime, Float magnitude, Boolean requestCut, Boolean successCut) {
    this.ffcrId = ffcrId;
    this.otId = otId;
