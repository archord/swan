 ...
 */
@Entity
@Table(name = "ot_level2_his", schema = "public"
)
public class OtLevel2His implements java.io.Serializable {
  ...
  public OtLevel2His(long otId, String name, Float ra, Float dec, Date foundTimeUtc, String identify, Float xtemp, Float ytemp, Integer lastFfNumber, Integer total, Boolean isRecognize, Short otType, String comments, Integer dpmId, String dateStr) {
    this.otId = otId;
    this.name = name;
    this.ra = ra;
    this.dec = dec;
