 ...
 */
@Entity
@Table(name = "fits_file_cut", schema = "public"
)
public class FitsFileCut implements java.io.Serializable {
  ...
  @Id
  @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "ffc_seq")
  @SequenceGenerator(name = "ffc_seq", sequenceName = "ffc_id_seq")
