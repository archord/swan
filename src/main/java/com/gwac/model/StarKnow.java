...
public class StarKnow  implements java.io.Serializable {
    ...
    public StarKnow(long starId, Long ffId, BigDecimal ra, BigDecimal dec, Float x, Float y, Date datetime, Float mag, Float magErr, Float ellipticity, Float signalNoise, Float fwhm, Float flux, Float fluxErr, Long cmpStarId, Long mchStarId) {
       this.starId = starId;
       this.ffId = ffId;
       this.ra = ra;
       this.dec = dec;
