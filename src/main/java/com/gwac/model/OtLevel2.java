...
//     private OtType otType;
    ...
    public OtLevel2(long otId, OtType otType, String name, Float ra, Float dec, Date foundTimeUtc, String identify, Float xtemp, Float ytemp, Integer lastFfNumber, Integer total, Short succOccurTimes, Short maxSuccOccurTimes, Boolean isRecognize, String comments, String dpmName) {
       this.otId = otId;
//       this.otType = otType;
       this.name = name;
       this.ra = ra;
