...
public class OtLevel2 implements java.io.Serializable {
  ...
  public OtLevel2(long otId, String name, Float ra, Float dec, Date foundTimeUtc, String identify, Float xtemp, Float ytemp, Integer lastFfNumber, Integer total, Boolean isRecognize, Short otType, String comments, Integer dpmId, String dateStr) {
    this.otId = otId;
    this.name = name;
    this.ra = ra;
    this.dec = dec;
  ...
  @SequenceGenerator(name = "ot_seq", sequenceName = "ot_id_seq")
