...
public class OtLevel2  implements java.io.Serializable {
    ...
    public OtLevel2(String comments, String dateStr, Float dec, Integer dpmId, Date foundTimeUtc, String identify, Boolean isRecognize, Integer lastFfNumber, String name, Short otType, Float ra, Integer total, Float xtemp, Float ytemp) {
     ...
     @GenericGenerator(name="generator", strategy="seqhilo", parameters={@Parameter(name="max_lo", value="49"), @Parameter(name="sequence", value="ot_leve2_seq")})@Id @GeneratedValue(generator="generator")
