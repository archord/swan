...
/**
 * OtObserveRecordLevel1His generated by hbm2java
 */
@Entity
@Table(name="ot_observe_record_level1_his"
    ,schema="public"
)
public class OtObserveRecordLevel1His  implements java.io.Serializable {
    ...
    public OtObserveRecordLevel1His() {
    }

	
    public OtObserveRecordLevel1His(long oorId) {
        this.oorId = oorId;
    }
