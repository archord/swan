...
public class FitsFile2DAOImpl extends BaseHibernateDaoImpl<FitsFile2> implements FitsFile2DAO {
  ...
  public FitsFile2Show getShowByName(String ffName) {
    ...
    Session session = getCurrentSession();
    String sql = "select ff2.*, oi1.obj_name group_name, oi2.obj_name unit_name, oi3.obj_name cam_name, oi4.obj_name grid_name, oi5.obj_name field_name "
            + "from fits_file2 ff2 "
            ...
            + "INNER JOIN object_identity oi5 ON oi5.obj_id=ff2.field_id "
            + "WHERE ff2.img_name=?";
