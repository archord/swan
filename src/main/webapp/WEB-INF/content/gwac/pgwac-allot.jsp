...
<div style="width:650px;text-align: left;">
  <s:form id="getOtBaseListForm"  action="get-ot-base-list" theme="simple" cssClass="yform">
    <table style="margin:auto; width:80%;">
      <tr>
	<td>开始日期：</td>
	<td><sj:datepicker value="yesterday" id="from" name="startDate" displayFormat="yy-mm-dd" label="开始日期" /></td>
	<td>结束日期：</td>
