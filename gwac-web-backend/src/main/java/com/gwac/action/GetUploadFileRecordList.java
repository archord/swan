...
public class GetUploadFileRecordList extends ActionSupport implements SessionAware {

  private static final long serialVersionUID = 5078264279068543593L;
  private static final Log log = LogFactory.getLog(GetUploadFileRecordList.class);
  // Your result List
  private List<UploadFileRecord> gridModel;
...
//  private List<DataProcessMachine> dpmList;
  ...
  public String execute() {
    ...
    String[] orderNames = {"uploadDate"};
    int[] sorts = {2};
    gridModel = ufrDao.findRecord(from, rows, orderNames, sorts);
    log.debug("from="+from);
    log.debug("to="+to);
   ...
   */
  public List<UploadFileRecord> getGridModel() {
    return gridModel;
  }
   ...
   */
  public void setGridModel(List<UploadFileRecord> gridModel) {
