...
<html class="ocks-org do-not-copy">
  <head>
    ...
    <link href="<%=request.getContextPath()%>/resource/css/rect.css" rel="stylesheet" type="text/css">
    <style>
  ...
  <body>
    ...
    <script>
      ...
      d3.json("<%=request.getContextPath()%>/resource/json/miserables.json", draw2);

      function draw(miserables) {
        var matrix = [],
