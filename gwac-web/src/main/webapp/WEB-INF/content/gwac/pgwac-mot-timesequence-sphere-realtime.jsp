...
<html>
    <head>
        ...
        <script language="javascript" type="text/javascript" src="${pageContext.request.contextPath}/resource/js/mot_timesequence_sphere_realtime.js"></script>
        ...
        <script>
            $(function () {
              ...
              var url = "/images/movObjCache/today.json";
              ...
              loadData();
              gwac.ot1DrawInterval = setInterval(loadData, gwac.playSpeed);
              ...
              function loadData() {
                ...
                var movUrl = url + "?" + curDate.getTime();
                ...
                d3.json(movUrl, function (errors, reqData) {
                  ...
                  if (typeof (motList) !== "undefined" && motList !== null && motList !== "") {
                    ...
                    gwac.currentFrame = gwac.lastFrame;
        ...
        <div id="main">
            ...
            <div id="toolbar">
                <table style="border:0">
                    ...
                    <tr><td width="70px">播放速度:</td><td><input type="text" id="playSpeed" class="ot1-input" value="15000"/></td></tr>
