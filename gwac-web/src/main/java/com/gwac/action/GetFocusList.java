...
public class GetFocusList extends ActionSupport {

  private static final long serialVersionUID = -3454448234583441394L;
  private static final Log log = LogFactory.getLog(GetFocusList.class);

  private int days;
  private String ccd;
  @Resource
  private FeedbackFocusDao dao;
  private String parStr;
  private String minDate;

  @Actions({
    @Action(value = "/get-focus-list", results = {
