...
public class GetTemperatureList extends ActionSupport {

  private static final long serialVersionUID = -3454448234583441394L;
  private static final Log log = LogFactory.getLog(GetTemperatureList.class);

  private int days;
  private String ccd;
  @Resource
  private CameraTemperatureMonitorDao dao;
  private String parStr;
  private String minDate;

  @Actions({
    @Action(value = "/get-temperature-list", results = {
