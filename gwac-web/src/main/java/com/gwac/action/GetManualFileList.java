...
public class GetManualFileList extends ActionSupport {

  private static final long serialVersionUID = 5073694279068591293L;
  private static final Log log = LogFactory.getLog(GetManualFileList.class);
  ...
  @Resource
  private ManualUploadFileDao dao;
